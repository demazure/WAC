...
/////////////////////////////////////////////////////////////////////////////////////////
// Run an analysis with Epos events
/////////////////////////////////////////////////////////////////////////////////////////
int main()
{
  cout << "<INFO> Epos Analysis - Starting" << endl;

  long nEventsRequested = 1000000;
  int  nEventsReport    = 10000;

  AnalysisConfiguration * ac = new AnalysisConfiguration("Epos","Epos","1.0");
  ...
  TwoPartCorrelationAnalyzer  * ana4 = new TwoPartCorrelationAnalyzer ("Epos_TPCA_PP",   ac,  event, eventFilter,particleFilter7,particleFilter8);

  NuDynTask * nudyn1 = new NuDynTask("Epos_NuDyn_ALL",    ac,  event, eventFilter,particleFilter1,particleFilter2);
  NuDynTask * nudyn2 = new NuDynTask("Epos_NuDyn_PiPi",   ac,  event, eventFilter,particleFilter3,particleFilter4);
  NuDynTask * nudyn3 = new NuDynTask("Epos_NuDyn_KK",     ac,  event, eventFilter,particleFilter5,particleFilter6);
  NuDynTask * nudyn4 = new NuDynTask("Epos_NuDyn_PP",     ac,  event, eventFilter,particleFilter7,particleFilter8);
  ...
  cout << "<INFO> Epos Model Analysis - Completed" << endl;
