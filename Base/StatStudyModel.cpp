...
ClassImp(StatStudyModel)
  ...
  StatStudyModel::StatStudyModel(double nPlusAvgReq, double nMinusAvgReq,
                                 double nPlusPlusAvgReq,
                                 double nPlusMinusAvgReq,
                                 double nMinusMinusAvgReq,
                                 double plusEfficiencyReq,
                                 double minusEfficiencyReq, long nEventsReq)
  : nPlusAvg(nPlusAvgReq), nMinusAvg(nMinusAvgReq), nPlusPlusAvg(nPlusPlusAvgReq), nPlusMinusAvg(nPlusMinusAvgReq), nMinusMinusAvg(nMinusMinusAvgReq), plusEfficiency(plusEfficiencyReq), minusEfficiency(minusEfficiencyReq), nEvents(nEventsReq)
{
}
