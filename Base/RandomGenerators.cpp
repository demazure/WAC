...
ClassImp(ScalarIntRandomGenerator)
  ...
  ScalarIntRandomGenerator::ScalarIntRandomGenerator(int min, int max,
                                                     TRandom* rg)
  : RandomGenerator(rg), minimum(min), maximum(max), range(max - min)
{
}
...
ClassImp(ExpScalarIntRandomGenerator)
  ...
  ExpScalarIntRandomGenerator::ExpScalarIntRandomGenerator(
    int minimum, double theSlope, TRandom* randomGenerator)
...
ClassImp(ScalarDoubleRandomGenerator)
  ...
  ScalarDoubleRandomGenerator::ScalarDoubleRandomGenerator(double min,
                                                           double max,
                                                           TRandom* rg)
  : RandomGenerator(rg), minimum(min), maximum(max), range(max - min)
{
...
ClassImp(LinearScalarDoubleRandomGenerator)
  ...
  LinearScalarDoubleRandomGenerator::LinearScalarDoubleRandomGenerator(
    double minimum, double maximum, TRandom* randomGenerator)
  : ScalarDoubleRandomGenerator(minimum * minimum, maximum * maximum,
                                randomGenerator)
{
}
...
ClassImp(ExpScalarDoubleRandomGenerator)
  ...
  ExpScalarDoubleRandomGenerator::ExpScalarDoubleRandomGenerator(
    double minimum, double slope, TRandom* randomGenerator)
...
ClassImp(HistoScalarDoubleRandomGenerator)
  ...
  HistoScalarDoubleRandomGenerator::HistoScalarDoubleRandomGenerator(
    TH1* theHistogram)
  : ScalarDoubleRandomGenerator(0, 0, 0), histogram(theHistogram)
{
}
