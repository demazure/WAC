...
void CanvasCollection::printCanvas(TCanvas* canvas, const TString& directoryName, bool printGif, bool printPdf, bool printSvg, bool printC)
{
  ...
  if (printGif)
    canvas->Print(fileName + ".gif");
  if (printPdf)
    canvas->Print(fileName + ".pdf");
  if (printSvg)
    canvas->Print(fileName + ".svg");
  if (printC)
    canvas->Print(fileName + ".C");
}
...
////////////////////////////////////////////////////
TLatex* CanvasCollection::createLabel(double x, double y, int color, int,
                                      double fontSize, const TString& text,
                                      bool doDraw)
{
  TLatex* label;
...
////////////////////////////////////////////////////
TLegend* CanvasCollection::createLegend(float x1, float y1, float x2, float y2,
                                        int, float fontSize)
{
...
// Create simple line
////////////////////////////////////////////////////
TLine* CanvasCollection::createLine(float x1, float y1, float x2, float y2,
                                    int style, int color, int width, bool)
{
...
// Create Arrow Line
////////////////////////////////////////////////////
TArrow* CanvasCollection::createArrow(float x1, float y1, float x2, float y2,
