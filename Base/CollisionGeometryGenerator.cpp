...
ClassImp(CollisionGeometryGenerator)
  ...
  : Task(name, configuration, nullptr), collisionGeometry(_collisionGeometry), nucleusGeneratorA(_nucleusGeneratorA), nucleusGeneratorB(_nucleusGeneratorB)
{
  ...
  if (reportDebug())
    cout << "CollisionGeometryGenerator::CollisionGeometryGenerator(...) No ops" << endl;
}
...
{
  if (reportDebug())
    cout << "CollisionGeometryGenerator::execute() Started" << endl;
  ...
  double xA, yA, zA;
  double xB, yB, zB;
  double xAvg, yAvg, zAvg, tAvg, dx, dy, dSq;
  ...
  if (reportDebug())
    cout << "CollisionGeometryGenerator::execute() Completed" << endl;
}
