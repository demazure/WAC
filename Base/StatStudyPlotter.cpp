                                 ...
                                 GraphConfiguration** graphConfigurations)
{
  ...
  histograms[0] = statStudyHistograms->f1_1;
  hLegends[0] = new TString("n_{1}^{(+)}");
  histograms[1] = statStudyHistograms->f1_2;
  hLegends[1] = new TString("n_{1}^{(-)}");
  histograms[2] = statStudyHistograms->f1_1Eff;
  hLegends[2] = new TString("n_{1}^{(+,Det)}");
  histograms[3] = statStudyHistograms->f1_2Eff;
  hLegends[3] = new TString("n_{1}^{(-,Det)}");
  plot(4, canvasNameBase + "f1", canvasConfiguration, graphConfigurations,
       "n_{1}", 0.0, 0.0,
       "P(n_{1})", 0.0, 0.0,
       histograms, hLegends, 0.7, 0.5, 0.85, 0.85, 0.055);

  histograms[0] = statStudyHistograms->f1_1Ratio;
  hLegends[0] = new TString("f_{1}^{(+,Det)}/f_{1}^{(+)}");
  histograms[1] = statStudyHistograms->f1_2Ratio;
  hLegends[1] = new TString("f_{1}^{(-,Det)}/f_{1}^{(-)}");
  ...
  histograms[0] = statStudyHistograms->f2_11;
  hLegends[0] = new TString("n_{2}^{(++)}");
  histograms[1] = statStudyHistograms->f2_12;
  hLegends[1] = new TString("n_{2}^{(+-)}");
  histograms[2] = statStudyHistograms->f2_22;
  hLegends[2] = new TString("n_{2}^{(--)}");
  histograms[3] = statStudyHistograms->f2_11Eff;
  hLegends[3] = new TString("n_{2}^{(++,Det)}");
  histograms[4] = statStudyHistograms->f2_12Eff;
  hLegends[4] = new TString("n_{2}^{(+-,Det)}");
  histograms[5] = statStudyHistograms->f2_22Eff;
  hLegends[5] = new TString("n_{2}^{(--,Det)}");
  plot(6, canvasNameBase + "f2", canvasConfiguration, graphConfigurations,
       "n_{2}", 0.0, 0.0,
       "P(n_{2})", 0.0, 0.0,
       histograms, hLegends, 0.7, 0.4, 0.85, 0.85, 0.055);

  histograms[0] = statStudyHistograms->f2_11Ratio;
  hLegends[0] = new TString("f_{2}^{(++,Det)}/f_{2}^{(++)}");
  histograms[1] = statStudyHistograms->f2_12Ratio;
  hLegends[1] = new TString("f_{2}^{(+-,Det)}/f_{2}^{(+-)}");
  histograms[2] = statStudyHistograms->f2_22Ratio;
  hLegends[2] = new TString("f_{2}^{(--,Det)}/f_{2}^{(--)}");
  ...
  histograms[0] = statStudyHistograms->r2_11;
  hLegends[0] = new TString("R_{2}^{(++)}");
  histograms[1] = statStudyHistograms->r2_12;
  hLegends[1] = new TString("R_{2}^{(+-)}");
  histograms[2] = statStudyHistograms->r2_22;
  hLegends[2] = new TString("R_{2}^{(--)}");
  histograms[3] = statStudyHistograms->r2_11Eff;
  hLegends[3] = new TString("R_{2}^{(++,Det)}");
  histograms[4] = statStudyHistograms->r2_12Eff;
  hLegends[4] = new TString("R_{2}^{(+-,Det)}");
  histograms[5] = statStudyHistograms->r2_22Eff;
  hLegends[5] = new TString("R_{2}^{(--,Det)}");
  plot(6, canvasNameBase + "R2", canvasConfiguration, graphConfigurations,
       "R_{2}", 0.0, 0.003,
       "P(R_{2})", 0.0, 0.0,
       histograms, hLegends, 0.70, 0.3, 0.85, 0.90, 0.065);

  histograms[0] = statStudyHistograms->r2_11Ratio;
  hLegends[0] = new TString("R_{2}^{(++,Det)}/R_{2}^{(++)}");
  histograms[1] = statStudyHistograms->r2_12Ratio;
  hLegends[1] = new TString("R_{2}^{(+-,Det)}/R_{2}^{(+-)}");
  histograms[2] = statStudyHistograms->r2_22Ratio;
  hLegends[2] = new TString("R_{2}^{(--,Det)}/R_{2}^{(--)}");
  ...
  histograms[0] = statStudyHistograms->nudyn_12;
  hLegends[0] = new TString("#nu_{Dyn}");
  histograms[1] = statStudyHistograms->nudyn_12Eff;
  hLegends[1] = new TString("#nu_{Dyn}^{(Det)}");
  ...
  histograms[0] = statStudyHistograms->nudyn_12Ratio;
  hLegends[0] = new TString("#nu_{dyn}^{(Det)}/#nu_{dyn}");
  ...
  histograms[0] = statStudyHistograms->f1_1Ratio_vsSub;
  hLegends[0] = new TString("Quad");
  histograms[1] = statStudyHistograms->f1_1RatioOptB_vsSub;
  hLegends[1] = new TString("Binomial");
  ...
  histograms[0] = statStudyHistograms->r2_11_vsSub;
  hLegends[0] = new TString("R_{2}^{(++)}");
  ...
  histograms[0] = statStudyHistograms->r2_11Ratio_vsSub;
  hLegends[0] = new TString("Quad");
  histograms[1] = statStudyHistograms->r2_11RatioOptB_vsSub;
  hLegends[1] = new TString("Binomial");
  ...
  histograms[0] = statStudyHistograms->nudyn_12_vsSub;
  hLegends[0] = new TString("#nu_{Dyn}^{12,Det}");
  plot(1, canvasNameBase + "nudyn_12Eff_vsSub-zoom", canvasConfiguration, graphConfigurations,
       "sub-sample", 950.0, 1020.0,
       "#nu_{Dyn}^{12,Det}", -0.0015, -0.0006,
       histograms, hLegends, 0.70, 0.8, 0.85, 0.9, 0.055);

  histograms[0] = statStudyHistograms->nudyn_12Ratio_vsSub;
  hLegends[0] = new TString("Quad");
  histograms[1] = statStudyHistograms->nudyn_12RatioOptB_vsSub;
  hLegends[1] = new TString("Binomial");
  ...
  histograms[0] = statStudyHistograms->ef1_1_vsSub;
  hLegends[0] = new TString("#delta(f_{1}^{(+)})/f_{1}^{(+)}");
  histograms[1] = statStudyHistograms->ef1_2_vsSub;
  hLegends[1] = new TString("#delta(f_{1}^{(-)})/f_{1}^{(-)}");
  histograms[2] = statStudyHistograms->ef1_1Eff_vsSub;
  hLegends[2] = new TString("#delta(f_{1}^{(+,Det)})/f_{1}^{(+,Det)}");
  histograms[3] = statStudyHistograms->ef1_2Eff_vsSub;
  hLegends[3] = new TString("#delta(f_{1}^{(-,Det)})/f_{1}^{(-,Det)}");
  ...
  histograms[0] = statStudyHistograms->ef1_1Ratio_vsSub;
  hLegends[0] = new TString("#delta(f_{1}^{(+,Det)}/f_{1}^{(+)})/f_{1}^{(+,Det)})/f_{1}^{(+)}");
  histograms[1] = statStudyHistograms->ef1_2Ratio_vsSub;
  hLegends[1] = new TString("#delta(f_{1}^{(-,Det)}/f_{1}^{(-)})/f_{1}^{(-,Det)})/f_{1}^{(-)}");
  ...
  histograms[0] = statStudyHistograms->er2_11_vsSub;
  hLegends[0] = new TString("#delta(R_{2}^{(++)})/R_{2}^{(++)}");
  histograms[1] = statStudyHistograms->er2_12_vsSub;
  hLegends[1] = new TString("#delta(R_{2}^{(+-)})/R_{2}^{(+-)}");
  histograms[2] = statStudyHistograms->er2_22_vsSub;
  hLegends[2] = new TString("#delta(R_{2}^{(--)})/R_{2}^{(--)}");
  histograms[3] = statStudyHistograms->er2_11Eff_vsSub;
  hLegends[3] = new TString("#delta(R_{2}^{(++,Det)})/R_{2}^{(++,Det)}");
  histograms[4] = statStudyHistograms->er2_12Eff_vsSub;
  hLegends[4] = new TString("#delta(R_{2}^{(+-,Det)})/R_{2}^{(+-,Det)}");
  histograms[5] = statStudyHistograms->er2_22Eff_vsSub;
  hLegends[5] = new TString("#delta(R_{2}^{(--,Det)})/R_{2}^{(--,Det)})");
  ...
  histograms[0] = statStudyHistograms->er2_11Ratio_vsSub;
  hLegends[0] = new TString("#delta(R_{2}^{(++,Det)}/R_{2}^{(++)})/R_{2}^{(++,Det)}/R_{2}^{(++)}");
  histograms[1] = statStudyHistograms->er2_12Ratio_vsSub;
  hLegends[1] = new TString("#delta(R_{2}^{(+-,Det)}/R_{2}^{(+-)})/R_{2}^{(+-,Det)}/R_{2}^{(+-)}");
  histograms[2] = statStudyHistograms->er2_22Ratio_vsSub;
  hLegends[2] = new TString("#delta(R_{2}^{(--,Det)}/R_{2}^{(--)})/R_{2}^{(--,Det)}/R_{2}^{(--)}");
  ...
  histograms[0] = statStudyHistograms->enudyn_12_vsSub;
  hLegends[0] = new TString("#delta(#nu_{Dyn}^{(+-)})/#nu_{Dyn}^{(+-)}");
  histograms[1] = statStudyHistograms->enudyn_12Eff_vsSub;
  hLegends[1] = new TString("#delta(#nu_{Dyn}^{(+-,Det)})/#nu_{Dyn}^{(+-,Det)}");
  ...
  histograms[0] = statStudyHistograms->enudyn_12Ratio_vsSub;
  hLegends[0] = new TString("#delta(#nu_{Dyn}^{(+-,Det)}/#nu_{Dyn}^{(+-)})/#nu_{Dyn}^{(+-,Det)}/#nu_{Dyn}^{(+-)}");
