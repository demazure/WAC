...
ClassImp(GraphConfiguration)
  ...
  : npx(100), npy(100), lineColor(1), lineStyle(1), lineWidth(2), markerColor(1), markerStyle(20), markerSize(1.1), nXDivisions(5), xTitleSize(0.06), xTitleOffset(1.1), xLabelSize(0.05), xLabelOffset(0.01), xTitle("x"), nYDivisions(5), yTitleSize(0.06), yTitleOffset(1.2), yLabelSize(0.05), yLabelOffset(0.01), yTitle("y"), nZDivisions(5), zTitleSize(0.06), zTitleOffset(1.5), zLabelSize(0.05), zLabelOffset(0.01), zTitle("z"), plotOption("E0")
{
  if (dim == 1 || dim == 0) {
    switch (type) {
      default:
