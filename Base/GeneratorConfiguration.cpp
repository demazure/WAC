...
ClassImp(GeneratorConfiguration)
  ...
  GeneratorConfiguration::GeneratorConfiguration(const TString& name,
                                                 const TString& type,
                                                 const TString& version)
  : TaskConfiguration(name, type, version), dataInputPath(""), dataFileMinIndex(0), dataFileMaxIndex(1),
