...
ClassImp(AnalysisConfiguration)
  ...
  : TaskConfiguration(name, type, version), histoBaseName(""), nBins_nPartTot(10), min_nPartTot(0.0), max_nPartTot(100.0), nBins_nCell(100), min_nCell(0.0), max_nCell(100.0), nBins_nPartPerCell(10), min_nPartPerCell(0.0), max_nPartPerCell(10.0), nBins_pt(40), min_pt(0.0), max_pt(2.0), range_pt(2.0), nBins_eta(20), min_eta(-2.0), max_eta(2.0), range_eta(4.0), nBins_y(20), min_y(-2.0), max_y(-2.0), range_y(4.0), nBins_phi(36), min_phi(0.0), max_phi(0.0), range_phi(0.0), nBins_phiEta(720), nBins_phiEtaPt(7200), nBins_phiY(720), nBins_phiYPt(7200), binCorrPM(1.0), binCorrMM(1.0), binCorrPP(1.0), nBins_DeltaPlong(10), min_DeltaPlong(-1.0), max_DeltaPlong(1.0), range_DeltaPlong(2.0), nBins_DeltaPside(10), min_DeltaPside(-1.0), max_DeltaPside(1.0), range_DeltaPside(2.0), nBins_DeltaPout(10), min_DeltaPout(-1.0), max_DeltaPout(1.0), range_DeltaPout(2.0), nBins_Dphi(36), min_Dphi(0.0), max_Dphi(0.0), width_Dphi(0.0), nBins_Dphi_shft(36), min_Dphi_shft(0.0), max_Dphi_shft(0.0), nBins_Deta(39), min_Deta(-2.0), max_Deta(2.0), width_Deta(4.0 / 39.0), nBins_Dy(39), min_Dy(-2.0), max_Dy(2.0), width_Dy(4.0 / 39.0), fillPairs(true), fill3D(false), fill6D(false), fillQ3D(false), fillY(true), nuDynVsMult(true), nuDynVsCent(false), nBins_mult(20), min_mult(0.0), max_mult(200.0), nBins_cent(20), min_cent(0.0), max_cent(100.0)
{
  max_phi = TMath::TwoPi();
