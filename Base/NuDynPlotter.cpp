                             ...
                             GraphConfiguration** graphConfigurations)
{
  ...
  histograms[0] = nuDynHistos->h_events_vsMult;
  histTitles[0] = new TString("N_{events}");
  ...
  for (int i1 = 0; i1 < nPart; i1++) {
    ...
    histograms[i1] = nuDynHistos->h_f1_vsMult[i1];
  ...
  for (int i1 = 0; i1 < nPart; i1++) {
    for (int i2 = i1; i2 < nPart; i2++) {
      ...
      histTitle += "}";
      cout << "Inserting: " << histTitle << endl;
      histograms[index12] = nuDynHistos->h_f2_vsMult[index12];
      histTitles[index12] = new TString(histTitle);
      nGraphs++;
    }
  }
  ...
  for (int i1 = 0; i1 < nPart; i1++) {
    for (int i2 = i1; i2 < nPart; i2++) {
      ...
      histTitle += "}";
      cout << "Inserting: " << histTitle << endl;
      histograms[index12] = nuDynDerivedHistos->h_F2_vsMult[index12];
      histTitles[index12] = new TString(histTitle);
  ...
  for (int i1 = 0; i1 < nPart; i1++) {
    for (int i2 = i1; i2 < nPart; i2++) {
      ...
      histTitle += "}";
      cout << "Inserting: " << histTitle << endl;
      histograms[index12] = nuDynDerivedHistos->h_R2_vsMult[index12];
      histTitles[index12] = new TString(histTitle);
      if (!histograms[index12]) {
        cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
        return;
  ...
  //      }
  //    }
  histograms[0] = nuDynHistos->h_f3_vsMult[1];
  histTitles[0] = new TString("f_{3}^{000}");
  ...
  for (int i1 = 0; i1 < nPart; i1++) {
    for (int i2 = i1; i2 < nPart; i2++) {
      for (int i3 = i2; i3 < nPart; i3++) {
        ...
        histTitle += "}";
        // cout << "Inserting: " << histTitle << endl;
        histograms[index123] = nuDynDerivedHistos->h_F3_vsMult[index123];
        histTitles[index123] = new TString(histTitle);
        if (!histograms[index123]) {
          cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
          return;
        }
  ...
  for (int i1 = 0; i1 < nPart; i1++) {
    for (int i2 = i1; i2 < nPart; i2++) {
      for (int i3 = i2; i3 < nPart; i3++) {
        ...
        histTitle += "}";
        cout << "Inserting: " << histTitle << endl;
        histograms[index123] = nuDynDerivedHistos->h_R3_vsMult[index123];
        histTitles[index123] = new TString(histTitle);
        if (!histograms[index123]) {
          cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
          return;
    ...
    for (int i2 = i1; i2 < nPart; i2++) {
      for (int i3 = i2; i3 < nPart; i3++) {
        for (int i4 = i3; i4 < nPart; i4++) {
          ...
          histTitle += "}";
          cout << "Inserting: " << histTitle << endl;
          histograms[index1234] = nuDynHistos->h_f4_vsMult[index1234];
          histTitles[index1234] = new TString(histTitle);
    ...
    for (int i2 = i1; i2 < nPart; i2++) {
      for (int i3 = i2; i3 < nPart; i3++) {
        for (int i4 = i3; i4 < nPart; i4++) {
          ...
          histTitle += "}";
          cout << "Inserting: " << histTitle << endl;
          histograms[index1234] = nuDynDerivedHistos->h_F4_vsMult[index1234];
          histTitles[index1234] = new TString(histTitle);
          if (!histograms[index1234]) {
            cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
            return;
    ...
    for (int i2 = i1; i2 < nPart; i2++) {
      for (int i3 = i2; i3 < nPart; i3++) {
        for (int i4 = i3; i4 < nPart; i4++) {
          ...
          histTitle += "}";
          cout << "Inserting: " << histTitle << endl;
          histograms[index1234] = nuDynDerivedHistos->h_R4_vsMult[index1234];
          histTitles[index1234] = new TString(histTitle);
          if (!histograms[index1234]) {
            cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
            return;
                                       ...
                                       GraphConfiguration** graphConfigurations)
{
  ...
  for (int i1 = 0; i1 < nGraphs; i1++) {
    ...
    histTitle += *histLabels[i1];
    cout << "Inserting: " << histTitle << endl;
    histograms[i1] = nuDynDerivedHistos[i1]->h_F4_vsMult[index1234];
    histTitles[i1] = new TString(histTitle);
    if (!histograms[i1]) {
      cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
      return;
  ...
  for (int i1 = 0; i1 < nGraphs; i1++) {
    ...
    histTitle += *histLabels[i1];
    cout << "Inserting: " << histTitle << endl;
    histograms[i1] = nuDynDerivedHistos[i1]->h_R4_vsMult[index1234];
    histTitles[i1] = new TString(histTitle);
    if (!histograms[i1]) {
      cout << "<F> Histograms not loaded!!!! ABORT!!!" << endl;
      return;
