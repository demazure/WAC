...
ClassImp(CollisionGeometryConfiguration)
  ...
  CollisionGeometryConfiguration::CollisionGeometryConfiguration(
    const TString& name, const TString& type, const TString& version)
  : TaskConfiguration(name, type, version), histoBaseName(""), minB(0.0), maxB(18.0), nnCrossSection(5555), nBins_b(100), min_b(0.0), max_b(18.0), nBins_nPart(500), min_nPart(0), max_nPart(500), nBins_nBinary(500), min_nBinary(0), max_nBinary(40000)
{
}
