...
ClassImp(Plotter)
  ...
  Plotter::Plotter()
  : CanvasCollection(), MessageLogger()
{
  if (reportDebug())
    cout << "Plotter::CTOR() No OPS." << endl;
}
...
// =======================================
TLatex* Plotter::createLabel(double x, double y, int color, int,
...
////////////////////////////////////////////////////
TLegend* Plotter::createLegend(float x1, float y1, float x2, float y2, int,
                               float fontSize)
{
...
{
  if (reportDebug())
    cout << "Setting properties of histo: " << g->GetTitle() << endl;
