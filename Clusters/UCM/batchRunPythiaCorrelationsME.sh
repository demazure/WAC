...
do
  ...
  sbatch -J batch__PythiaCorr --array=1-$NSUBJOBS --chdir=$WORKINGDIRECTORY --time=03:00:00 -o $WORKINGDIRECTORY/Job_%A_%a.out -e $WORKINGDIRECTORY/Job_%A_%a.err /home/victorG/PROJECTS/WAC/Clusters/UCM/runPythiaCorrelationsME.sh
